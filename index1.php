...
<html lang="en">
 ...
 <style type="text/css">
  ...
  <body style="background-image: url('images/444.JPG');background-size: cover;">

    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

       <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><b> HOSPITAL MANAGEMENT SYSTEM</b></h4></a>
