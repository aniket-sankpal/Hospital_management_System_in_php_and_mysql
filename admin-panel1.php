...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="logout1.php"><i class="fa fa-power-off" aria-hidden="true"></i> <b>Logout</b></a>
      </li>
       <li class="nav-item">
  ...
  <body style="padding-top:50px; background-color:#6ac0e6">
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1 text-white">
